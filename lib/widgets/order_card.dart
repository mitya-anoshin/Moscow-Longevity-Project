...
import '../features/single_order_page/models/order.dart';
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            _getOrderIconWidget(order.status),
            SizedBox(
              width: 25.0,
            ),
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  _textRow("Placed On", _formatter.format(order.placedDate)),
                  SizedBox(
                    height: 5.0,
                  ),
                  _textRow("Delivery On", _formatter.format(order.arrivalDate))
                ],
              ),
            ),
          ],
...
Widget _textRow(String textOne, String textTwo) {
  return Wrap(
    children: [
      Text(
        "$textOne:",
...
Widget _getOrderIconWidget(OrderStatus status) {
  switch (status) {
    case OrderStatus.PICKING_UP:
      return Container(
        ...
        child: Icon(
          Typicons.looped_square_interest,
